...
def run(historical_import: bool = False) -> None:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="IB Trade Journal sync")
    parser.add_argument("--init", action="store_true",
                        help="Full historical import (same as regular run — Flex Query always fetches all)")
    args = parser.parse_args()
    run(historical_import=args.init)
